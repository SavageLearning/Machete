        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=64, category = LCategory.skill, typeOfWorkID=21, speciality=false,  ltrCode="", minHour=1, wage=15,    sortorder=2,  text_EN = "housecleaning",             text_ES = "trabajo domÃ©stico", selected=false },
                ...
                new Lookup { ID=66, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="P", minHour=1, wage=15,    sortorder=5,  text_EN = "painter (spray)",          text_ES = "pintor (mÃ¡quina)",   selected=false, subcategory="paint", level=2 },
                ...
                new Lookup { ID=70, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="C", minHour=1, wage=15,    sortorder=9,  text_EN = "carpentry (siding / framing)", text_ES = "carpinterÃ­a (revestimiento / encuadre)",   selected=false, subcategory="carpentry", level=1 },
                ...
                new Lookup { ID=73, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="G", minHour=1, wage=15,    sortorder=4,  text_EN = "Gardening",                text_ES = "JardinerÃ­a avanzada",                               selected=false,subcategory="garden", level=2},
                new Lookup { ID=74, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="G", minHour=1, wage=15,    sortorder=1,  text_EN = "Yardwork",                 text_ES = "trabajar en el jardÃ­n",  subcategory="garden", level=2, selected=false},
