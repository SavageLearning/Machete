        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=98,category = LCategory.activityName, text_EN="Financial Education", text_ES="Educación Fiscal", selected = false},                new Lookup { ID=105,category = LCategory.emailstatus, key= LEmailStatus.ReadyToSend, text_EN="Ready to send",         text_ES="Listo para enviar",          selected = false },
                new Lookup { ID=99,category = LCategory.emailstatus, key= LEmailStatus.Sent, text_EN="Sent",         text_ES="Enviado",          selected = false },
                new Lookup { ID=100,category = LCategory.emailstatus, key= LEmailStatus.TransmitError, text_EN="Transmit error",         text_ES="Error en la transmisión",          selected = false },
                new Lookup { ID=101,category = LCategory.emailstatus, key= LEmailStatus.Sending, text_EN="Sending",         text_ES="Mandando...",          selected = false },
                new Lookup { ID=102,category = LCategory.emailstatus, key= LEmailStatus.Pending, text_EN="Pending",         text_ES="Pendiente",          selected = false },
                new Lookup { ID=103,category = LCategory.emailTemplate, key= LKey.Default, text_EN="default template (English)", text_ES="plantilla predeterminada (Ingles)", selected=true, emailTemplate="Thanks for using Machete! You can change this in the Config section."}
            };
        //
        //
