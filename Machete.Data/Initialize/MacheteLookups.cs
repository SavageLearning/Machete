        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=20, category = LCategory.worktype,     text_EN = "(DWC) Day Worker Center",    text_ES = "(DWC) Centro del Trabajadores", ltrCode="DWC", selected=true},
                new Lookup { ID=21, category = LCategory.worktype,     text_EN = "(HHH) Household Helpers",    text_ES = "(HHH) Trabajadoras de la casa", ltrCode="HHH", selected=false},
                new Lookup { ID=22, category = LCategory.worktype,     text_EN = "Special event",        text_ES = "Acto especial", ltrCode="EVT", selected=false},                
