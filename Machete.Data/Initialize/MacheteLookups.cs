        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=6, category = "race", text_EN = "Native American",text_ES="Indígena",selected = false},
                ...
                //begin neighborhoods
                new Lookup { ID=113, category = "neighborhood",    text_EN = "Unknown",            text_ES = "No conocido",        selected=true},
                ...
                new Lookup { ID=114, category = "neighborhood",     text_EN = "New York",          text_ES = "Nueva York",         selected=false},
                new Lookup { ID=115, category = "neighborhood",     text_EN = "Manhattan",         text_ES = "Manhattan",          selected=false},
                new Lookup { ID=116, category = "neighborhood",     text_EN = "Bronx",             text_ES = "Bronx",              selected=false},
                new Lookup { ID=117, category = "neighborhood",     text_EN = "Queens",            text_ES = "Queens",             selected=false},
                new Lookup { ID=118, category = "neighborhood",     text_EN = "Brooklyn",          text_ES = "Brooklyn",           selected=false},
                new Lookup { ID=119, category = "neighborhood",     text_EN = "Staten Island",     text_ES = "Staten Island",      selected=false},
                // Portland, without neighborhoods 
                new Lookup { ID=120, category = "neighborhood",     text_EN = "Portland",          text_ES = "Portland",           selected=false},
                //San Francisco area cities, without neighborhoods
                new Lookup { ID=121, category = "neighborhood",     text_EN = "San Francisco",     text_ES = "San Francisco",      selected=false},
                new Lookup { ID=122, category = "neighborhood",     text_EN = "Hayward",           text_ES = "Hayward",            selected=false},
                new Lookup { ID=123, category = "neighborhood",     text_EN = "Santa Cruz",        text_ES = "Santa Cruz",         selected=false},
                new Lookup { ID=124, category = "neighborhood",     text_EN = "Graton",            text_ES = "Gréton",             selected=false},
                new Lookup { ID=125, category = "neighborhood",     text_EN = "Mountain View",     text_ES = "Mountain View",      selected=false},
                // begin incomes ... TODO: update these income levels to match Fed. pov guidelines vs. 1, 2, 3, 4 persons
                // see e.g. http://aspe.hhs.gov/poverty/13poverty.cfm
                ...
                // work types (based on Casa Latina programs; no other center has had HHH programs in place)
                ...
                new Lookup { ID=22, category = "worktype",     text_EN = "Special event",              text_ES = "Evento especial", selected=false}, 
                // how employers referred == empplrreference
                new Lookup { ID=126, category = "emplrreference",   text_EN = "Website",      text_ES = "Sitio de la Red", selected=false},
                ...
                new Lookup { ID=32, category = "transportmethod",   text_EN = "Worker Center Van",  text_ES = "Van del Centro Laboral",   sortorder=1,  selected=false},
                ...
                // out of order to make geographical sense to humans, makes no difference to C#/SQL
                ...
                new Lookup { ID=54, category = "countryoforigin",     text_EN = "Colombia", text_ES = "Colombia", selected=false},
                new Lookup { ID=56, category = "countryoforigin",     text_EN = "Venezuela", text_ES = "Venezuela", selected=false},
                ...
                new Lookup { ID=105, category = "countryoforigin",    text_EN = "Uruguay", text_ES = "Uruguay", selected=false},
                new Lookup { ID=106, category = "countryoforigin",    text_EN = "Paraguay", text_ES = "Paraguay", selected=false},
                new Lookup { ID=107, category = "countryoforigin",    text_EN = "Dominican Republic", text_ES = "República Dominicana", selected=false},
                new Lookup { ID=108, category = "countryoforigin",    text_EN = "Haiti", text_ES = "Haiti", selected=false},
                new Lookup { ID=109, category = "countryoforigin",    text_EN = "Puerto Rico (U.S.)", text_ES = "Puerto Rico (EE.UU.)", selected=false},
                new Lookup { ID=75, category = "countryoforigin",     text_EN = "Cuba", text_ES = "Cuba", selected=false},
                // Eurasia (these have shown up in beta testing)
                ...
                new Lookup { ID=110, category = "countryoforigin",    text_EN = "Spain", text_ES = "España", selected=false},
                // Africa (these have shown up in beta testing)
                new Lookup { ID=111, category = "countryoforigin",     text_EN = "Ethiopia", text_ES = "Etiopía", selected=false},
                new Lookup { ID=112, category = "countryoforigin",     text_EN = "Eritrea", text_ES = "Eritrea", selected=false},
                // Begin skills
