    ...
    public static class MacheteLookup    {
        ...
        public static void Initialize(MacheteContext context) {
            new List<Lookup>
            {
                ...
                new Lookup { ID=17, category = "income",     text_EN = "Less than $10,000",            text_ES = "Menos que $10.000",          selected=false},
                new Lookup { ID=18, category = "income",     text_EN = "Between $10,000 and $25,000",  text_ES = "Entre $ 10.000 y $ 25.000",  selected=false},
                new Lookup { ID=19, category = "income",     text_EN = "Above $25,000",                text_ES = "Por encima de $ 25.000",     selected=false},
                new Lookup { ID=20, category = "worktype",     text_EN = "(DWC) Home Improvement",    text_ES = "Mejoras para el hogar", selected=true},
                new Lookup { ID=21, category = "worktype",     text_EN = "(HHH) Household Help",     text_ES = "(HHH) Limpieza de la casa", selected=false},
                ...
                new Lookup { ID=60, category = "skill",     minHour=5, wage=12,   text_EN = "general labor",                               text_ES = "general del trabajo",                      selected=true},
                new Lookup { ID=61, category = "skill",     minHour=5, wage=15,   text_EN = "painter (rollerbrush)",                       text_ES = "pintor (rollerbrush)",                     selected=false},
                new Lookup { ID=62, category = "skill",     minHour=5, wage=18,   text_EN = "painter (spray)",                             text_ES = "pintor (spray)",                           selected=false},
                new Lookup { ID=63, category = "skill",     minHour=5, wage=15,   text_EN = "insulation / sheetrock / taping / drywall",   text_ES = "aislamiento / yeso / grabación / yeso",    selected=false},
                new Lookup { ID=64, category = "skill",     minHour=5, wage=18,   text_EN = "Build retaining wall / fence",                text_ES = "Construir muro / valla",                   selected=false},
                new Lookup { ID=65, category = "skill",     minHour=5, wage=18,   text_EN = "carpentry (siding / framing)",                text_ES = "carpintería (revestimiento / encuadre)",   selected=false},
                new Lookup { ID=66, category = "skill",     minHour=5, wage=18,   text_EN = "brick / masonry / tile setting",              text_ES = "ladrillo / hormigón / baldosa ajuste",     selected=false},
                new Lookup { ID=67, category = "skill",     minHour=5, wage=15,   text_EN = "Gardening",                                   text_ES = "Jardinería",                               selected=false},
                new Lookup { ID=68, category = "skill",     minHour=5, wage=15,   text_EN = "Moving",                                      text_ES = "Movimiento de casa",                       selected=false},
                new Lookup { ID=69, category = "skill",     minHour=5, wage=15,   text_EN = "Gardening",                                   text_ES = "Jardinería",                               selected=false},
                new Lookup { ID=70, category = "skill",     minHour=5, wage=13,   text_EN = "Digging/Weeding",                             text_ES = "Excavación / deshierbar",                  selected=false},
                new Lookup { ID=71, category = "skill",     minHour=1, wage=30,   text_EN = "DWC Chambita 1hr",                            text_ES = "DWC Chambita 1hr",  fixedJob=true, selected=false},
                new Lookup { ID=72, category = "skill",     minHour=2, wage=20,   text_EN = "DWC Chambita 2hr",                            text_ES = "DWC Chambita 2hr",  fixedJob=true, selected=false},
                new Lookup { ID=73, category = "skill",     minHour=3, wage=16.667,text_EN = "DWC Chambita 3hr",                           text_ES = "DWC Chambita 3hr",  fixedJob=true, selected=false},
                new Lookup { ID=74, category = "skill",     minHour=2, wage=25,   text_EN = "HHH Chambita 2hr",                            text_ES = "HHH Chambita 2hr",  fixedJob=true, selected=false},
                new Lookup { ID=77, category = "skill",     minHour=5, wage=15,   text_EN = "Demolition",                            text_ES = "Demolición",  fixedJob=false, selected=false},
