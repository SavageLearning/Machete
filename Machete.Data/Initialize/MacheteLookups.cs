        ...
        private static List<Lookup> _cache = new List<Lookup>
            {
                ...
                new Lookup { ID=26, category = LCategory.transportmethod,   text_EN = "Worker buses",       text_ES = "Trabajador en bus",    sortorder=2,  selected=true},
                new Lookup { ID=27, category = LCategory.transportmethod,   text_EN = "Worker drives",      text_ES = "Trabajador en carro",  sortorder=5,  selected=false },
                new Lookup { ID=28, category = LCategory.transportmethod,   text_EN = "Employer Picks up",  text_ES = "Patron lleva",         sortorder=5,  selected=false },
                new Lookup { ID=29, category = LCategory.transportmethod,   text_EN = "Van service",    text_ES = "Servicio de van",   sortorder=1,  selected=false },
                new Lookup { ID=30, category = LCategory.transportmethod,   text_EN = "Worker walks",       text_ES = "Trabajador camina",    sortorder=5,  selected=false },
                new Lookup { ID=31, category = LCategory.maritalstatus,     text_EN = "Single", text_ES = "Individual", selected=true },
                new Lookup { ID=32, category = LCategory.maritalstatus,     text_EN = "Married", text_ES = "Casado", selected=false },
                ...
                new Lookup { ID=63, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="", minHour=1, wage=15,    sortorder=2,  text_EN = "general labor",              text_ES = "trabajo general",                      selected=true, key=LKey.Default },
                new Lookup { ID=64, category = LCategory.skill, typeOfWorkID=21, speciality=false,  ltrCode="", minHour=1, wage=15,    sortorder=2,  text_EN = "housecleaning",              text_ES = "trabajo general",                      selected=false, key=LKey.Default },
                new Lookup { ID=65, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="P", minHour=1, wage=15,    sortorder=5,  text_EN = "painter (rollerbrush)",                       text_ES = "pintor (cepillo)",   selected=false, subcategory="paint", level=1 },
                new Lookup { ID=66, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="P", minHour=1, wage=15,    sortorder=5,  text_EN = "painter (spray)",                             text_ES = "pintor (máquina)",   selected=false, subcategory="paint", level=2 },
                new Lookup { ID=67, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="B", minHour=1, wage=15,    sortorder=9,  text_EN = "drywall (patch/tape)",   text_ES = "yeso (arreglar o poner cinta)",           selected=false, subcategory="build", level=1 },
                new Lookup { ID=68, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="B", minHour=1, wage=15,    sortorder=9,  text_EN = "drywall (hang)",   text_ES = "yeso (colgar)",                                 selected=false, subcategory="build", level=2 },
                new Lookup { ID=69, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="B", minHour=1, wage=15,    sortorder=9,  text_EN = "insulation",   text_ES = "aislamiento",                                       selected=false, subcategory="build", level=3 },
                new Lookup { ID=70, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="C", minHour=1, wage=15,    sortorder=9,  text_EN = "carpentry (siding / framing)", text_ES = "carpintería (revestimiento / encuadre)",   selected=false, subcategory="carpentry", level=1 },
                new Lookup { ID=71, category = LCategory.skill, typeOfWorkID=20, speciality=true,   ltrCode="C", minHour=1, wage=15,    sortorder=9,  text_EN = "masonry",              text_ES = "ladrillo y ajuste de baldosas",     selected=false, subcategory="carpentry", level=2 },
                new Lookup { ID=72, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="", minHour=1, wage=15,    sortorder=5,  text_EN = "Moving",                                       text_ES = "Mudanza",                       selected=false},
                new Lookup { ID=73, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="G", minHour=1, wage=15,    sortorder=4,  text_EN = "Gardening",                                   text_ES = "Jardinería avanzada",                               selected=false,subcategory="garden", level=2},
                new Lookup { ID=74, category = LCategory.skill, typeOfWorkID=20, speciality=false,  ltrCode="G", minHour=1, wage=15,    sortorder=1,  text_EN = "Yardwork",                                    text_ES = "trabajar en el jardín",  subcategory="garden", level=2, selected=false},
                new Lookup { ID=75, category = LCategory.skill, typeOfWorkID=20, speciality=true,  ltrCode="G", minHour=1, wage=15, sortorder=9, text_EN = "Landscaping", text_ES = "Paisajismo", fixedJob=false, selected=false, subcategory="garden", level=3},
                new Lookup { ID=76, category = LCategory.skill, typeOfWorkID=20, speciality=true,  ltrCode="R", minHour=1, wage=15, sortorder=9, text_EN = "Roofing", text_ES = "Techado", fixedJob=false, selected=false, subcategory="roof", level=1},
                ...
                new Lookup { ID=88, category = LCategory.activityName, text_EN="Basic English",      text_ES="Inglés basico",       selected = true },
                new Lookup { ID=89, category = LCategory.activityName, text_EN="Intermediate English",      text_ES="Inglés intermedio",       selected = false },
                new Lookup { ID=90,category = LCategory.activityName, text_EN="Assembly",         text_ES="Asamblea",          selected = false },
                new Lookup { ID=91,category = LCategory.activityName, text_EN="Volunteering",         text_ES="Voluntariado",          selected = false },
                new Lookup { ID=92,category = LCategory.activityName, text_EN="OSHA Training", text_ES="Capacitación", selected = false},
                new Lookup { ID=93,category = LCategory.activityName, text_EN="Health & Safety",         text_ES="Salud y seguridad",          selected = false },
                new Lookup { ID=94,category = LCategory.activityName, text_EN="Leadership Development", text_ES="Liderazgo", selected = false},
                new Lookup { ID=95,category = LCategory.activityName, text_EN="Basic Gardening", text_ES="Jardinería Básica", selected = false},
                new Lookup { ID=96,category = LCategory.activityName, text_EN="Advanced Gardening", text_ES="Jardinería Avanzada", selected = false},
                new Lookup { ID=97,category = LCategory.activityName, text_EN="Financial Education", text_ES="Educación Fiscal", selected = false},                new Lookup { ID=105,category = LCategory.emailstatus, key= LEmailStatus.ReadyToSend, text_EN="Ready to send",         text_ES="Listo para enviar",          selected = false },
                new Lookup { ID=98,category = LCategory.emailstatus, key= LEmailStatus.Sent, text_EN="Sent",         text_ES="Enviado",          selected = false },
                new Lookup { ID=99,category = LCategory.emailstatus, key= LEmailStatus.TransmitError, text_EN="Transmit error",         text_ES="Error en la transmisión",          selected = false },
                new Lookup { ID=100,category = LCategory.emailstatus, key= LEmailStatus.Sending, text_EN="Sending",         text_ES="Mandando...",          selected = false },
                new Lookup { ID=101,category = LCategory.emailstatus, key= LEmailStatus.Pending, text_EN="Pending",         text_ES="Pendiente",          selected = false },
                new Lookup { ID=102,category = LCategory.emailTemplate, key= LKey.Default, text_EN="default template (English)", text_ES="plantilla predeterminada (Ingles)", selected=true, emailTemplate="Thanks for using Machete! You can change this in the Config section."}
            };
        //
        //
