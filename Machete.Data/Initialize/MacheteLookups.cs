    ...
    public static class MacheteLookup    {
        ...
        public static void Initialize(MacheteContext context) {
            new List<Lookup>
            {
                ...
                new Lookup { ID=60, category = "skill", typeOfWorkID=20, speciality=false,  minHour=5, wage=12,    sortorder=2,  text_EN = "general labor",                               text_ES = "general del trabajo",                      selected=true},
                new Lookup { ID=61, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=15,    sortorder=5,  text_EN = "painter (rollerbrush)",                       text_ES = "pintor (rollerbrush)",                     selected=false, subcategory="paint", level=1 },
                new Lookup { ID=62, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=18,    sortorder=5,  text_EN = "painter (spray)",                             text_ES = "pintor (spray)",                           selected=false, subcategory="paint", level=2 },
                new Lookup { ID=63, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=15,    sortorder=9,  text_EN = "insulation / sheetrock / taping / drywall",   text_ES = "aislamiento / yeso / grabación / yeso",    selected=false},
                new Lookup { ID=64, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=18,    sortorder=9,  text_EN = "Build retaining wall / fence",                text_ES = "Construir muro / valla",                   selected=false},
                new Lookup { ID=65, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=18,    sortorder=9,  text_EN = "carpentry (siding / framing)",                text_ES = "carpintería (revestimiento / encuadre)",   selected=false},
                new Lookup { ID=66, category = "skill", typeOfWorkID=20, speciality=true,   minHour=5, wage=18,    sortorder=9,  text_EN = "brick / masonry / tile setting",              text_ES = "ladrillo / hormigón / baldosa ajuste",     selected=false},
                new Lookup { ID=67, category = "skill", typeOfWorkID=21, speciality=false,  minHour=5, wage=15,    sortorder=3,  text_EN = "HHH housework",                               text_ES = "HHH trabajo de casa",                      selected=false},
                new Lookup { ID=68, category = "skill", typeOfWorkID=20, speciality=false,  minHour=5, wage=15,    sortorder=5,  text_EN = "Moving",                                      text_ES = "Movimiento de casa",                       selected=false},
                new Lookup { ID=69, category = "skill", typeOfWorkID=20, speciality=false,  minHour=5, wage=15,    sortorder=4,  text_EN = "Gardening",                                   text_ES = "Jardinería",                               selected=false, subcategory="garden", level=2},
                new Lookup { ID=70, category = "skill", typeOfWorkID=20, speciality=false,  minHour=5, wage=13,    sortorder=1,  text_EN = "Digging/Weeding",                             text_ES = "Excavación / deshierbar",                  selected=false, subcategory="garden", level=1},
                new Lookup { ID=71, category = "skill", typeOfWorkID=20, speciality=false,  minHour=1, wage=30,    sortorder=9,  text_EN = "DWC Chambita 1hr",                            text_ES = "DWC Chambita 1hr",       fixedJob=true, selected=false},
                new Lookup { ID=72, category = "skill", typeOfWorkID=20, speciality=false,  minHour=2, wage=20,    sortorder=9,  text_EN = "DWC Chambita 2hr",                            text_ES = "DWC Chambita 2hr",       fixedJob=true, selected=false},
                new Lookup { ID=73, category = "skill", typeOfWorkID=20, speciality=false,  minHour=3, wage=16.667,sortorder=9,  text_EN = "DWC Chambita 3hr",                           text_ES = "DWC Chambita 3hr",       fixedJob=true, selected=false},
