...
namespace Machete.Identity
{
    public static class UserServiceExtensions
    {
        public static void ConfigureUserService(this IdentityServerServiceFactory factory, string connString)
        {
            ...
            factory.Register(new Registration<MacheteContext>(resolver => new MacheteContext(connString)));
        }
    }

    public class UserService : AspNetIdentityUserService<MacheteUser, string>
    {
        ...
        protected override async Task<IEnumerable<System.Security.Claims.Claim>> GetClaimsFromAccount(MacheteUser user)
        {
