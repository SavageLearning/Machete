...
namespace Machete.Service
{
    public static class MacheteConfigs
    {
        private static List<Config> list = new List<Config>
        {
            ...
            new Config { key = Cfg.OrderReviewWorkerCountLabel, category = "OnlineOrders", publicConfig = true, value = "OrderReviewWorkerCountLabel", description = "Displayed in the pre-sumbit review step. The label for the count of work assignments"},
            new Config { key = Cfg.OrderReviewSkillsSummaryLabel, category = "OnlineOrders", publicConfig = true, value = "OrderReviewSkillsSummaryLabel", description = "Displayed in the pre-sumbit review step. The label for the work assignments summary table"},
            new Config { key = Cfg.OrderReviewTransportFeeMethodHelper, category = "OnlineOrders", publicConfig = true, value = "OrderReviewTransportFeeMethodHelper", description = "Displayed in the pre-sumbit review step. The helper text for transport fees explaining payment options"},
            new Config { key = Cfg.OrderReviewLaborCostMethodHelper, category = "OnlineOrders", publicConfig = true, value = "OrderReviewLaborCostMethodHelper", description = "Displayed in the pre-sumbit review step. The helper text for labor cost explaining payment options"},
            new Config { key = Cfg.OrderReviewTransportFeeAboutUrl, category = "OnlineOrders", publicConfig = true, value = "OrderReviewTransportFeeAboutUrl", description = "Displayed in the pre-sumbit review step. The url to your website explaining the transport fees"},
            new Config { key = Cfg.OrderReviewLaborCostAboutUrl, category = "OnlineOrders", publicConfig = true, value = "OrderReviewLaborCostAboutUrl", description = "Displayed in the pre-sumbit review step. The url to your website explaining the labor cost"},
            new Config { key = Cfg.OrderReviewNextStepsHelper, category = "OnlineOrders", publicConfig = true, value = "OrderReviewNextStepsHelper", description = "Displayed in the pre-sumbit review step. Describe the next steps in the process, will employer need to wait for confirmation via a call, text or wait for email, etc."},
            new Config { key = Cfg.DisableWorkersVaccineRequirement, category = "OnlineOrders", publicConfig = true, value = "FALSE", description = "Enter either TRUE or FALSE. Enter TRUE to turn off the vaccine requirement question on the online hiring portal"},
